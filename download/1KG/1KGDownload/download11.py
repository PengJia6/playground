...
for line in open("/mnt/MyFiles/1KG/aspera_download_part"+str(part)+".pbs"):
    ...
    if linenum>5:
        ...
        # print(case)
download={}
for line in open("/mnt/MyFiles/1KG/download_part"+str(part)+"_new"):
    download[line[:-1]]=""
print(download)
file=open("/mnt/MyFiles/1KG/aspera_download_part"+str(part)+"_new.sh","w")
file.write("#!/bin/bash\n"
            "ASCP=/home/sunyu/.aspera/connect/bin/ascp\n"
           "ASCPSSH=/home/sunyu/.aspera/connect/etc/asperaweb_id_dsa.openssh\n"
